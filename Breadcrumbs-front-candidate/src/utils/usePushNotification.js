...
/** Le fichier ci-dessous est légèrement inspiré de : 
 * https://github.com/Spyna/push-notification-demo/blob/master/front-end-react/src/usePushNotifications.js
 * 
 * Des changements devront êtres faits
*/
...
/*   useEffect(() => {
  ...
  const onClickSendNotification = async () => {
    setLoading(true);
    setError(false);
    await axios.get("https://breadcrumbs.pwa.fr/api/tips").catch(err => {
      setLoading(false);
      setError(err);
    });
    setLoading(false);
